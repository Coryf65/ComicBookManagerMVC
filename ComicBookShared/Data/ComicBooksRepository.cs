...
{
    public class ComicBooksRepository //Will make this availble to code in the Web App Project
    {

        private Context _context = null;

        public ComicBooksRepository(Context context) //allows the controller to manage the lifetime of the context
        {
            _context = context;
        }
